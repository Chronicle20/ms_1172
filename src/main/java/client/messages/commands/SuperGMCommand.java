      ...
      player.changeSkillsLevel(sa);
            ...
            return true;
                ...
                case "resetother":
                    ...
                    return true;
                case "fstartother":
                    MapleQuest.getInstance(Integer.parseInt(splitted[2])).forceStart(c.getChannelServer().getPlayerStorage().getCharacterByName(splitted[1]), Integer.parseInt(splitted[3]));
                    return true;
                case "fcompleteother":
                ...
                case "completequest":
                    ...
                    return true;
                case "fstartquest":
                    MapleQuest.getInstance(Integer.parseInt(splitted[1])).forceStart(c.getPlayer(), Integer.parseInt(splitted[2]));
                    return true;
                case "fcompletequest":
