...
public class PortalScriptManager {
    ...
    private final static ScriptEngineFactory sef = new ScriptEngineManager().getEngineByName("graal.js").getFactory();
    ...
    private void createPortalScript(MapleClient c,String name,int mapid,MaplePortal portal) throws IOException{
        ...
        if (portalnpc == 0) 
            return;
        NPCScriptManager.getInstance().start( c ,portalnpc, null);// ask if trying to get back
