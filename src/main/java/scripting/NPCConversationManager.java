...
//    }
   ...
   public void sendNext(String text) {
      getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "00 01", (byte) 0));
   }
    ...
    public void sendNext(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "00 01", speaker));
    }

    public void sendPrev(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "01 00", speaker));
    }

    public void sendNextPrev(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "01 01", speaker));
    }

   public void sendOk(String text) {
      getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "00 00", (byte) 0));
   }

    public void sendOk(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0, text, "00 00", speaker));
    }

    public void sendYesNo(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 1, text, "", speaker));
    }

    public void sendAcceptDecline(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 0x0C, text, "", speaker));
    }
...
//    }
    ...
    public void sendSimple(String text) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 4, text, "", (byte) 0));
    }

    public void sendSimple(String text, byte speaker) {
        getClient().announce(NPCPacket.getNPCTalk(npc, (byte) 4, text, "", speaker));
    }

    public void sendStyle(String text, int[] styles) {
        if (styles.length > 0) {
            getClient().announce(NPCPacket.getNPCTalkStyle(npc, text, styles));
...
//    }
    ...
    public void sendGetNumber(String text, int def, int min, int max) {
        getClient().announce(NPCPacket.getNPCTalkNum(npc, text, def, min, max));
    }

    public void sendGetText(String text) {
        getClient().announce(NPCPacket.getNPCTalkText(npc, text, ""));
    }
