...
import scripting.QuestScriptManager;
        ...
        switch (action) {
            ...
            case 4: { // Scripted Start Quest
                ...
                if (q.canStart(chr, npc)) {
                    QuestScriptManager.getInstance().start(c, (short) quest, npc);
                }
                break;
            }
            case 5: { // Scripted End Quest
                ...
                if (q.canComplete(chr, npc)) {
                    QuestScriptManager.getInstance().end(c, (short) quest, npc);
                }

//                NPCScriptManager.getInstance().end(c, npc, quest, false);
